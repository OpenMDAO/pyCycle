...
class HBTF(pyc.Cycle):
    ...
    def setup(self):
        ...
        self.pyc_add_element('fan', pyc.Compressor(map_data=pyc.FanMap, design=design, thermo_data=thermo_spec,
        ...
        self.pyc_add_element('duct4', pyc.Duct(design=design, thermo_data=thermo_spec))
        ...
        self.pyc_add_element('duct11', pyc.Duct(design=design, thermo_data=thermo_spec))
        ...
        self.pyc_add_element('duct13', pyc.Duct(design=design, thermo_data=thermo_spec))
        ...
        self.pyc_add_element('duct15', pyc.Duct(design=design, thermo_data=thermo_spec))
