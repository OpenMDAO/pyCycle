...
class WetSimpleTurbojetTestCase(unittest.TestCase): 
    ...
    def benchmark_case1(self): 
        ...
        tol = 1e-5
        print()
        assert_near_equal(prob['DESIGN.inlet.Fl_O:stat:W'][0], 146.97968493, tol)
        assert_near_equal(prob['DESIGN.perf.OPR'][0], 13.5, tol)
        assert_near_equal(prob['DESIGN.balance.FAR'][0], 0.017711187, tol)
        assert_near_equal(prob['DESIGN.balance.turb_PR'][0], 3.86850290, tol)
        assert_near_equal(prob['DESIGN.perf.Fg'][0], 11800.004971016797, tol)
        assert_near_equal(prob['DESIGN.perf.TSFC'][0], 0.79419199, tol)
        assert_near_equal(prob['DESIGN.comp.Fl_O:tot:T'][0], 1188.36444, tol)
        assert_near_equal(prob['OD1.inlet.Fl_O:stat:W'][0], 142.137154, tol)
        assert_near_equal(prob['OD1.perf.OPR'][0], 12.840611, tol)
        assert_near_equal(prob['OD1.balance.FAR'][0], 0.01680313, tol)
        ...
        assert_near_equal(prob['OD1.perf.TSFC'][0], 0.7816417336, tol)
        assert_near_equal(prob['OD1.comp.Fl_O:tot:T'][0], 1167.760455, tol)
