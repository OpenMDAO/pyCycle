...
class WetSimpleTurbojetTestCase(unittest.TestCase): 
    ...
    def benchmark_case1(self): 
        ...
        assert_near_equal(prob['DESIGN.balance.FAR'][0], 0.017572031188180025, tol)
        assert_near_equal(prob['DESIGN.balance.turb_PR'][0], 3.875643986180359, tol)
        assert_near_equal(prob['DESIGN.perf.Fg'][0], 11800.004971016797, tol)
        assert_near_equal(prob['DESIGN.perf.TSFC'][0], 0.7905952385516549, tol)
        assert_near_equal(prob['DESIGN.comp.Fl_O:tot:T'][0], 1189.9234289259114, tol)
        assert_near_equal(prob['OD1.inlet.Fl_O:stat:W'][0], 142.61579623157436, tol)
        assert_near_equal(prob['OD1.perf.OPR'][0], 12.840815856937581, tol)
        assert_near_equal(prob['OD1.balance.FAR'][0], 0.016671169969447452, tol)
        ...
        assert_near_equal(prob['OD1.perf.TSFC'][0], 0.7781145361588018, tol)
        assert_near_equal(prob['OD1.comp.Fl_O:tot:T'][0], 1169.2667871381, tol)
