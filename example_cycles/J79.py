...
from pycycle.elements.api import FlightConditions, Inlet, Compressor, Combustor, Turbine, Nozzle, Shaft, Duct, Performance
...
if __name__ == "__main__":
    ...
    for pt in pts:
        prob.model.add_subsystem(pt, Turbojet(design=False, statics=OD_statics))
