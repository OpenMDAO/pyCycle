...
from openmdao.api import ImplicitComponent, NewtonSolver, DirectSolver, BoundsEnforceLS, ArmijoGoldsteinLS
from openmdao.api import ScipyIterativeSolver, PetscKSP, AnalysisError
...
class ChemEq(ImplicitComponent):
