...
class PsResid(ImplicitComponent):
    ...
    def solve_nonlinear(self, inputs, outputs):
        ...
        try:
            ...
            raise AnalysisError('Bad values flow states in {}: Ts={}'.format(self.pathname, inputs['Ts']))
    ...
    def linearize(self, inputs, outputs, J):
        ...
        if mode=="MN":
            ...
            try:
                ...
                raise AnalysisError('{} Bad value in static calc: rho={}, Vsonic={}, area={}'.format(self.pathname, rho, Vsonic, area))
