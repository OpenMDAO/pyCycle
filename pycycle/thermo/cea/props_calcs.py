...
class PropsCalcs(ExplicitComponent):
    ...
    def compute_partials(self, inputs, J):
        ...
        dCp_dresultT = np.zeros(num_element+1, dtype=inputs._get_data().dtype)
        # for i in range(num_element):
        ...
        dCv_dresultP = np.zeros((1, num_element+1), dtype=inputs._get_data().dtype)
        ...
        dgamma_dresultT = np.zeros((1, num_element+1), dtype=inputs._get_data().dtype)
        ...
        gamma_dresultP = np.zeros((1, num_element+1), dtype=inputs._get_data().dtype)
