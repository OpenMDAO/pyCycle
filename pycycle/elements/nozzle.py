...
from openmdao.api import Group, ExplicitComponent, ImplicitComponent, IndepVarComp, BalanceComp
from openmdao.api import BoundsEnforceLS, NewtonSolver, DirectSolver
...
class PR_bal(ImplicitComponent):
...
class PressureCalcs(ExplicitComponent):
    """
...
class PerformanceCalcs(ExplicitComponent):
    """
...
class Nozzle(Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('mach_choked', IndepVarComp('MN', 1.000, ))
...
if __name__ == "__main__":
    ...
    p.model.add_subsystem('des_var1', IndepVarComp('W', 57.00, units='lbm/s'))
    p.model.add_subsystem('des_var2', IndepVarComp('Pt', 14.0, units='lbf/inch**2'))
    p.model.add_subsystem('des_var3', IndepVarComp('Tt', 1662.44, units='degR'))
    p.model.add_subsystem('des_var4', IndepVarComp('dPqP', 0.0))
    p.model.add_subsystem('des_var5', IndepVarComp('Ps_exhaust', 14.696, units='lbf/inch**2'))
