...
from openmdao.api import Group, ImplicitComponent, ExplicitComponent, MetaModelStructuredComp, BalanceComp, IndepVarComp
...
if __name__ == "__main__":
    ...
    des_vars = p.model.add_subsystem(
        'des_vars', IndepVarComp(), promotes=['*'])
