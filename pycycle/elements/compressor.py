...
from openmdao.api import Group, ExplicitComponent, ScipyIterativeSolver, LinearRunOnce, IndepVarComp
...
class CorrectedInputsCalc(ExplicitComponent):
...
class eff_poly_calc(ExplicitComponent):
...
class BleedsAndPower(ExplicitComponent):
...
class EnthalpyRise(ExplicitComponent):
...
class PressureRise(ExplicitComponent):
