...
import numpy as np
from openmdao.api import Group, ExplicitComponent, AnalysisError
...
class EnthalpyDrop(ExplicitComponent):
...
class Bleeds(ExplicitComponent):
...
class EnthalpyAndPower(ExplicitComponent):
