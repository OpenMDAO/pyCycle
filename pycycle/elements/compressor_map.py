from openmdao.api import Group, ExplicitComponent, ImplicitComponent, MetaModelStructuredComp, IndepVarComp, BalanceComp
from pycycle.maps.ncp01 import NCP01

import numpy as np


class StallCalcs(ExplicitComponent):
...
class ScaledMapValues(ExplicitComponent):
