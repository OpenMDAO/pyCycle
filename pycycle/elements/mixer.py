...
from openmdao.api import ExplicitComponent, Group, BalanceComp, NewtonSolver, DirectSolver, \
                         BoundsEnforceLS, ExecComp
...
class MixFlow(ExplicitComponent):
    """
...
class AreaSum(ExplicitComponent):
...
class Impulse(ExplicitComponent):
...
class Mixer(Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('extraction_ratio', ExecComp('ER=Pt1/Pt2', Pt1={'units':'Pa'}, Pt2={'units':'Pa'}),
