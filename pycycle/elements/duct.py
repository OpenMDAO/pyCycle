...
class MachPressureLossMap(ExplicitComponent):
    """
...
class PressureLoss(ExplicitComponent):
    """
...
if __name__ == "__main__":
    ...
    p.model.add_subsystem('des_vars', IndepVarComp(params), promotes=['*'])
