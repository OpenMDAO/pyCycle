...
class FlowIn(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('%s:tot:composition'%fl_name, val=np.ones(num_elements)/(10*num_elements), desc='assigned kg-atoms of element i per total kg of reactant for the initial prod amounts')
        ...
        self.add_input('%s:stat:composition'%fl_name, val=np.ones(num_elements)/(10*num_elements), desc='assigned kg-atoms of element i per total kg of reactant for the initial prod amounts')
